...
/**
 * SingleStopBoard Component
 *
 * Display component for a single stop's departure information.
 * Used by the /board/[provider]/[stopId] route.
...
export function SingleStopBoard({
  data,
  title,
