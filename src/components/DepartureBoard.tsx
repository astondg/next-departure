 ...
 *
 * This is a Client Component that also renders on the server (SSR).
 * Progressive enhancement: works without JS, animations added when JS available.
 */
        ...
        {showWelcome && (
          ...
          <div className="p-4 text-center">
            ...
            {onSettingsClick ? (
              ...
              <a
                href="/settings"
                className="inline-block bg-black text-white px-4 py-2 font-bold no-underline"
              >
                Configure Stops
              </a>
            )}
